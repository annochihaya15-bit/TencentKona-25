...
import sun.security.ssl.NamedGroup.SupportedGroups;
...
public class SM2EKeyExchange {
    ...
    private static final class SM2EKAGenerator
        ...
        public SSLKeyDerivation createKeyDerivation(
            ...
            SM2KeyAgreementParamSpec params = context instanceof ServerHandshakeContext
                    ? createServerParams((ServerHandshakeContext) context)
                    : createClientParams((ClientHandshakeContext) context);
            return new SM2KAKeyDerivation("SM2", context, params,
                    sm2ePossession.ephemeralPrivateKey,
                    sm2eCredentials.ephemeralPublicKey);
        }

        private SM2KeyAgreementParamSpec createServerParams(ServerHandshakeContext shc) {
            SM2EPossession sm2ePossession = null;
        ...
        private SM2KeyAgreementParamSpec createClientParams(ClientHandshakeContext chc) {
            TLCP11Possession tlcpPossession = null;
